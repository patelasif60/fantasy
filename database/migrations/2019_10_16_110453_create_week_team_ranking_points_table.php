...
class CreateWeekTeamRankingPointsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('week_team_ranking_points', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('week_team_ranking_points');
    }
}
