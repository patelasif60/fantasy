...
var LeagueStandingsInfo = function() {
    ...
    var initDatatableMatch = function() {
        ...
        if (! $.fn.DataTable.isDataTable( 'js-table-match') ) {
            ...
            datatableMatch = $('.js-table-match').DataTable({
                ajax: $(".js-data-filter-tabs").data('url')+'?competition='+EUROPA_LEAGUE+'&phase='+phase+'&group='+group+'&team='+Site.europaTeamOne,
                responsive: true,
                searching: false,
                paging: false,
                info: false,
    ...
    var initDatatableGroup = function() {
        if (! $.fn.DataTable.isDataTable( 'js-group-filter') ) {
            ...
            datatableGroup = $('.js-group-filter').DataTable({
                ajax: $("#info-group-tab").data('url')+'?competition='+EUROPA_LEAGUE+'&group='+group,
                responsive: true,
                searching: false,
                paging: false,
                info: false,
    ...
    var getData = function(phase,group,dataTable) {
        dataTable.ajax.url($(".js-data-filter-tabs").data('url')+'?competition='+EUROPA_LEAGUE+'&phase='+phase+'&group='+group+'&team='+Site.europaTeamOne+'').load();
    }
