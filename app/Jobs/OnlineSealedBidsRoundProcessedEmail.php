...
use App\Mail\Manager\OnlineSealedBid\RoundProcessed;
...
class OnlineSealedBidsRoundProcessedEmail implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $round = $auctionRoundService->getActiveRound($this->division);
