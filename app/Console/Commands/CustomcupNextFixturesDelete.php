...
class CustomcupNextFixturesDelete extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'customcupfixtures:generate-next-delete {date?}';
     ...
     * @var string
     */
    protected $description = 'Command to delete generated next fixture for customcup';
    ...
    public function handle()
    {
        ...
        $this->service->generateNextFixturesDelete(Carbon::parse($date));
