...
class CustomcupFixtures extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'customcupfixtures:generate {date?}';
    ...
    public function handle()
    {
        ...
        info('Generate custom cup fixtures for '.$date);

        $this->service->manageFixtures($date);
