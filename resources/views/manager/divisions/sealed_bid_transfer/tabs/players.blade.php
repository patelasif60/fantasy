<div class="data-container-area">
    <div class="player-data-container">
        <div class="auction-content-wrapper px-4 pb-4 pt-4">
        ...
        <div class="player-data-wrapper">
            <div class="table-responsive">
                <table class="table text-center custom-table js-table-filter-players" data-url="{{ route('manage.transfer.online.sealed.bid.json.players',['division' => $division, 'team' => $team ]) }}"></table>
            </div>
        </div>
    </div>
</div>
