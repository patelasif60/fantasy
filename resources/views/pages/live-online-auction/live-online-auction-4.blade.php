                            ...
                            <ul class="nav nav-pills nav-justified theme-tabs theme-tabs-secondary mb-4" id="pills-tab" role="tablist">
                             ...
                             <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="auctioneer" role="tabpanel" aria-labelledby="auctioneer-tab">
                                    <p>It is Ben Grout’s turn to nominate a player.
                                    Please input the player name below along
                                    with their opening bid.</p>

                                    <div class="form-group">
                                        <label for="nominated-player">Nominated player</label>
                                        <input type="text" class="form-control" id="nominated-player" name="nominated-player" placeholder="Start typing player name or shortcode">
                                    </div>

                                    <div class="form-group">
                                        <label for="value">Value (£m)</label>
                                        <input type="text" class="form-control" id="value" name="value" placeholder="e.g. 0.5">
                                    </div>
