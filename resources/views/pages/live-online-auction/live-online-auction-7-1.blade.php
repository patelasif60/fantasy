                             ...
                             <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="auctioneer" role="tabpanel" aria-labelledby="auctioneer-tab">
                                    ...
                                    <div class="row mb-2 gutters-md">
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-outline-white btn-block">Change remote managers</button>
                                        </div>
                                        <div class="col-sm-6 mt-2 mt-sm-0">
                                            <button type="submit" class="btn btn-primary btn-block h-100">Begin round 2</button>
                                        </div>
                                    </div>
                                </div>
