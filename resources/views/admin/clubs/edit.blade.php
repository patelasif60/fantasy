...
@push('page-scripts')
<script src="{{ asset('js/admin/clubs/edit.js') }}"></script>
@endpush

@section('content')

<form class="js-club-edit-form" action="{{ route('admin.clubs.update', ['club' => $club]) }}" method="post" enctype="multipart/form-data">
    {{ method_field('PUT') }}
    {{ csrf_field() }}
    <div class="block">
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('name') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{ $club->name }}" placeholder="Club name">
                        @if ($errors->has('name'))
                ...
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('api_id') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="api_id" name="api_id" value="{{ $club->api_id }}" placeholder="API ID">
                ...
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('short_name') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="short_name" name="short_name" value="{{ $club->short_name }}" placeholder="Short name">
                ...
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('short_code') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="short_code" name="short_code" value="{{ $club->short_code }}" placeholder="Short code">
                    ...
                    <div class="form-group{{ $errors->has('is_premier') ? ' is-invalid' : '' }}">
                        <div class="row no-gutters items-push">
                            <label class="css-control css-control-primary css-checkbox">
                                <input type="checkbox" class="css-control-input" name="is_premier" @if($club->is_premier == 1) checked @endif>
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-hero btn-noborder btn-primary">Update club</button>
