...
@push('page-scripts')
<script src="{{ asset('js/admin/users/admin/create.js') }}"></script>
@endpush

@section('content')

<form class="js-admin-create-form" action="{{ route('admin.users.admin.store') }}" method="post">
    {{ csrf_field() }}
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Add Admin User</h3>
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-hero btn-noborder btn-primary">Create Admin</button>
