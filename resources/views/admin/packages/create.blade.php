...
@push('page-scripts')
<script src="{{ asset('js/admin/packages/create.js') }}"></script>
@endpush

@section('content')

<form class="js-package-create-form" action="{{ route('admin.packages.store') }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="block">
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('minimum_teams') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="minimum_teams" name="minimum_teams" placeholder="Minimum teams">
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('maximum_teams') ? ' is-invalid' : '' }}">
                        <label for="maximum_teams" class="required">Maximum teams:</label>
                        <input type="text" class="form-control" id="maximum_teams" name="maximum_teams" placeholder="Maximum teams">
                    </div>
                </div>
                <div class="col-xl-6">
                ...
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('default_prize_pack') ? ' is-invalid' : '' }}">
                        <label for="default_prize_pack">Default prize pack:</label>
                        <select class="form-control js-select2" id="default_prize_pack" name="default_prize_pack">
                            <option selected="selected" value="">Select Prize Pack</option>
                        </select>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('max_free_places') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="max_free_places" name="max_free_places" placeholder="Max free places">
                    </div>
                </div>
                <div class="col-xl-6">
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('pre_season_auction_budget') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="pre_season_auction_budget" name="pre_season_auction_budget">
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('pre_season_auction_bid_increment') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="pre_season_auction_bid_increment" name="pre_season_auction_bid_increment">
                    </div>
                </div>
                <div class="col-xl-6">
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('seal_bids_budget') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="seal_bids_budget" name="seal_bids_budget">
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('seal_bid_increment') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="seal_bid_increment" name="seal_bid_increment">
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('seal_bid_minimum') ? ' is-invalid' : '' }}">
                        <label for="seal_bid_minimum" class="required">Bid minimum:</label>
                        <input type="text" class="form-control" id="seal_bid_minimum" name="seal_bid_minimum">
                    </div>
                </div>
                 <div class="col-xl-6">
                ...
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('first_seal_bid_deadline') ? ' is-invalid' : '' }}">
                        <label for="first_seal_bid_deadline">First round deadline:</label>
                ...
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('max_seal_bids_per_team_per_round') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="max_seal_bids_per_team_per_round" name="max_seal_bids_per_team_per_round">
                    </div>
                </div>
                <div class="col-xl-6">
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('default_squad_size') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="default_squad_size" name="default_squad_size">
                    </div>
                </div>
                <div class="col-xl-6">
                    ...
                    <div class="form-group{{ $errors->has('default_max_player_each_club') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="default_max_player_each_club" name="default_max_player_each_club">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row no-gutters items-push">
                            @foreach($formation as $key => $value)
                                ...
                                <input type="checkbox" class="css-control-input formation-group" value="{{$key}}" id="available_formations-{{$key}}" name="available_formations[]">
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('season_free_agent_transfer_limit') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="season_free_agent_transfer_limit" name="season_free_agent_transfer_limit">
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('monthly_free_agent_transfer_limit') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="monthly_free_agent_transfer_limit" name="monthly_free_agent_transfer_limit">
                    </div>
                </div>
                <div class="col-xl-6">
                ...
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('allow_max_bids_per_round') ? ' is-invalid' : '' }}">
                        ...
                        <select class="form-control js-select2" id="allow_max_bids_per_round" name="allow_max_bids_per_round">
                            @foreach($yesNo as $key => $value)
                                <option value="{{ $key }}" @if($key == old('allow_max_bids_per_round')) selected  @endif>{{$value}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row no-gutters items-push">
                            @foreach($moneyBackEnum as $key => $value)
                                <label class="css-control css-control-primary css-checkbox">
                                <input type="checkbox" class="css-control-input money-back-group" value="{{$key}}" id="money_back_types-{{$key}}" name="money_back_types[]">
                                <span class="css-control-indicator"></span> {{$value}}
                            </label>
                            @endforeach
                        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                 ...
                                 <div class='parentDiv mb-0 form-group{{ $errors->has("points.$event_key.$position_key") ? " is-invalid" : "" }}'>
                                    ...
                                    @if($event_key == 'goal')
                                        <input type="text" class="form-control events-points positivePoint" name="points[{{$event_key}}][{{$position_key}}]" value="3">
                                    @elseif($event_key == 'assist')
                                        <input type="text" class="form-control events-points" name="points[{{$event_key}}][{{$position_key}}]" value="2">
                                    @elseif($event_key == 'goal_conceded' && $position_key != 'mid_fielder' && $position_key != 'striker')
                                        <input type="text" class="form-control events-points negativePoint" name="points[{{$event_key}}][{{$position_key}}]" value="-1">
                                    @elseif($event_key == 'clean_sheet' && $position_key != 'mid_fielder' && $position_key != 'striker')
                                        <input type="text" class="form-control events-points" name="points[{{$event_key}}][{{$position_key}}]" value="2">
                                    @elseif($event_key == 'appearance' && $position_key != 'mid_fielder' && $position_key != 'striker')
                                        <input type="text" class="form-control events-points" name="points[{{$event_key}}][{{$position_key}}]" value="1">
                                    @elseif($event_key == 'red_card' || $event_key == 'yellow_card' || $event_key == 'own_goal' || $event_key == 'penalty_missed' || $event_key == 'goal_conceded')
                                        <input type="text" class="form-control events-points negativePoint" name="points[{{$event_key}}][{{$position_key}}]">
                                    @else
                                        <input type="text" class="form-control events-points" name="points[{{$event_key}}][{{$position_key}}]">
                                    @endif
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-hero btn-noborder btn-primary">Create Package</button>
