...
@push('page-scripts')
<script src="{{ asset('js/admin/options/crests/create.js') }}"></script>
@endpush

@section('content')

<form class="js-crest-create-form" action="{{ route('admin.options.crests.store') }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Add Badge</h3>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="form-group{{ $errors->has('name') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Badge name" maxlength="100">
                        @if ($errors->has('name'))
                ...
                <div class="col-xl-6">
                    ...
                    <div class="row no-gutters items-push">
                        <label class="css-control css-control-primary css-checkbox">
                            <input type="checkbox" class="css-control-input" id="filter-is_published" name="is_published" value="1">
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-hero btn-noborder btn-primary">Create Badge</button>
