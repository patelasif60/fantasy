...
|Method|URI|Headers|
|:-|:-|:-|
|GET|`/api/division/{division}/preauction/rules/scoring/{event}`|`Bearer Token`|
...
```json
{
    "data": {
        ...
        "event": "goal",
        "positions": {
            "goal_keeper": "Goalkeeper (GK)",
            "full_back": "Full-back (FB)",
            "centre_back": "Centre-back (CB)",
            "defensive_mid_fielder": "Defensive Midfielder (DMF)",
            "mid_fielder": "Midfielder (MF)",
            "striker": "Striker (ST)"
        },
        "points": {
            "goal": {
...
```
> {info} The Scoring System -> Points is to be shown in the mentioned screens as per the PRE-3.3 Pre-auction state mock-up.
